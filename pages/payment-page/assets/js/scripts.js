document.addEventListener("DOMContentLoaded", function () {
    ...
    if (["credit-card", "debit-card"].includes(paymentMethod)) {
        paymentHTML = `
            ...
            <input type="text" id="card-number" name="card-number" placeholder="1234567890123456" class="payment-input" required pattern="[0-9]{16}" maxlength="16" title="Card number must be exactly 16 digits.">
            ...
            <input type="text" id="cvv" name="cvv" placeholder="123" class="payment-input" required pattern="[0-9]{3,4}" maxlength="4" title="CVV must be 3 or 4 digits.">
        `;
